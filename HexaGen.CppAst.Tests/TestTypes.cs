...
",
                compilation =>
                {
                    ...
                    Assert.AreEqual(baseTemplate.TemplateKind, CppTemplateKind.TemplateClass);
                    Assert.AreEqual(fullSpecializedClass.TemplateKind, CppTemplateKind.TemplateSpecializedClass);
                    Assert.AreEqual(partialSpecializedTemplate.TemplateKind, CppTemplateKind.PartialTemplateClass);
